...
import controllers.KeyEventManager;
...
public class LetterPresenter {
    ...
    private void setupKeyEventManager() {
        ...
        this.keyEventManager.addHandler(KeyCode.W, e -> this.increaseScale());
        this.keyEventManager.addHandler(KeyCode.S, e -> this.decreaseScale());
        this.keyEventManager.addHandler(KeyCode.A, e -> this.translateXNegative());
        this.keyEventManager.addHandler(KeyCode.D, e -> this.translateXPositive());
    }
